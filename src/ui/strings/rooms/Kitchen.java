...
public class Kitchen {
    ...
    */
    ...
    /**
    * The name string for the 'locked drawer' item.
    */
    public static final String LOCKED_DRAWER
        = "locked drawer";

    /**
    * The name string for the 'open drawer' item.
    */
    public static final String OPEN_DRAWER
        = "open drawer";
    /**
    ...
    */
    public static final String DESC_OVEN
        = "In the corner of the kichen there sits an old cast-iron wood burning oven.\n"
        + "The dark heavy unoven door stills open and cold waiting for its next use.\n";
    /**
    ...
    */
    ...
    /**
    * The description string for the 'loacked drawer' item.
    */
    public static final String DESC_LOCKED_DRAWER
    ...
    */
    public static final String DESC_OPEN_DRAWER
    ...
    */
    public static final String DESC_BOARD
        ...
        + "The boards look large and heavy like they were cut in prepartion of something.";
